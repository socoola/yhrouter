...
<body bgcolor=#E0FFFF onLoad="initValue()">
...
//if (ipsecvpn == "en") {
a.add(307, 300, _("treeapp vpn"),              "javascript:go('internet/ipsec.asp');");
//}
a.add(308, 300, _("DTU"),              "javascript:go('internet/dtu.asp');");

a.add(309, 300, _("treeapp sms"),              "javascript:go('internet/msg.asp');");
a.add(310, 300, _("treeapp status_report"),              "javascript:go('internet/status_report.asp');");

a.add(311, 300, _("treeapp route fail over"),              "javascript:go('internet/linkbackup.asp');");
a.add(312, 300, _("GPS"),              "javascript:go('internet/gps.asp');");
//a.add(313, 300, _("SNMP"),              "javascript:go('internet/snmp.asp');");
//a.add(313, 300, _("VRRP"),              "javascript:go('internet/vrrp.asp');");
...
a.add(902, 900, _("treeapp reboot"),            "javascript:go('adm/reboot.asp');");
a.add(903, 900, _("treeapp upload firmware"),       "javascript:go('adm/upload_firmware.asp');");
a.add(904, 900, _("treeapp settings management"),   "javascript:go('adm/settings.asp');");
a.add(905, 900, _("treeapp status"),                "javascript:go('adm/status.asp');");
a.add(906, 900, _("treeapp statistics"),            "javascript:go('adm/statistic.asp');");
//a.add(907, 900, _("treeapp system command"),        "javascript:go('adm/system_command.asp');");
if (syslogb == "1")
{
