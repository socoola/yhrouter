...
<form style="display: none" method=post name="rb_network_form" action="/goform/rb_network_action" onSubmit="return rb_network_applyClick()">
...
<form method=post name="rb_timer_form" action="/goform/rb_timer_action" onSubmit="return rb_timer_applyClick()">
...
<form method=post name="rb_form" action="/goform/rb_action">
