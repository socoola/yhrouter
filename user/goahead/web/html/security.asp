...
<p style="display:none" id="securityIntroduction">Setup the wireless security and encryption to prevent from unauthorized access and monitoring.</p>
<hr /><br/>
...
<table border="0" bordercolor="#9babbd" cellpadding="3" cellspacing="1" hspace="2" vspace="2" width="540">
  ...
  <tr id="div_security_shared_mode" name="div_security_shared_mode" style="visibility: hidden;"> 
    ...
    <td>
      <select name="security_shared_mode" id="security_shared_mode" size="1" onchange="securityMode(1)" style="width:75">
...
for(aptable = 0; aptable < MBSSID_MAX; aptable++){
	document.write(" <table id=AccessPolicy_"+ aptable +" border=0 bordercolor=#9babbd cellpadding=3 cellspacing=1 hspace=2 vspace=2 width=540>");
	document.write(" <tbody> <tr> <td class=title colspan=2 >"+_("secure access policy")+"</td></tr>");
	document.write(" <tr> <td  class=head >"+_("secure access policy capable")+"</td>");
...
<table border="0" cellpadding="2" cellspacing="1" width="540">
  <tbody><tr align="center">
    ...
    <td>
      <input style="width: auto;" value="Apply" id="secureApply" onclick="submit_apply()" type="button"> &nbsp; &nbsp;
      <input style="width: auto;" value="Cancel" id="secureCancel" type="reset" onClick="window.location.reload()" >
    </td>
  </tr>
</tbody></table>
</form>
