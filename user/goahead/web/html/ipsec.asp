...
<table class="body">
<tr><td>
<h1 id="Ipsectitle">IPSEC   Settings </h1>
<% checkIfUnderBridgeModeASP(); %>
<p id="Ipsecintroduce"> IPSEC</p>
<hr />
...
<br>
<h1 id="pptptitle">PPTP </h1>
<form name="pptp" action="/goform/pptp_action" method=POST onSubmit="return pptp_on_apply()">
	  <table width="540" border="0" cellpadding="2" cellspacing="1">
	  	<tr>
...
<br>
<h1 id="l2tptitle">L2TP </h1>
<form name="l2tp" action="/goform/l2tp_action" method=POST onSubmit="return l2tp_on_apply()">
	  <table width="540" border="0" cellpadding="2" cellspacing="1">
	  	<tr>
